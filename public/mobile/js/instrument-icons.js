...
const iconPaths = {
    Erhu: '/mobile/icons/instruments/erhu.svg',
    Guzheng: '/mobile/icons/instruments/guzheng.svg',
    Pipa: '/mobile/icons/instruments/pipa.svg',
    Dizi: '/mobile/icons/instruments/dizi.svg',
    Suona: '/mobile/icons/instruments/suona.svg',
    Hulusi: '/mobile/icons/instruments/hulusi.svg',
    Ocarina: '/mobile/icons/instruments/ocarina.svg',
    Violin: '/mobile/icons/instruments/violin.svg',
    Guitar: '/mobile/icons/instruments/guitar.svg',
    Piano: '/mobile/icons/instruments/piano.svg'
};
